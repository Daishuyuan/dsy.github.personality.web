...
legacyPath: "/2018/02/28/算法探究(C)之大杂烩(1)/"
toc: true
tags:
    - 算法
    - C++
...
> ----------------------问题的数学描述-------------------------- 
&emsp;&emsp;已知有集合 <img src="https://latex.codecogs.com/gif.latex? Activity{<N_1,C_1>,<N_2,C_2>,<N_3,C_3>,...,<N_n,C_n>} " />;
产生一个挑选集合<img src="https://latex.codecogs.com/gif.latex? Select{<N_1^{'},C_1^{'}>,<N_2^{'},C_2^{'}>,<N_3^{'},C_3^{'}>,...,<N_n^{'},C_n^{'}>}" />;
使得<img src="https://latex.codecogs.com/gif.latex? Score=N_1^{'}*C_1+N_2^{'}*C_2^{'}+....+N_n^{'}*C_n $且满足$(N_1^{'} \le N_1,N_2^{'} \le N_2,...,N_n^{'} \le N_n)" />
...
&emsp;&emsp;&emsp;&emsp;if <img src="https://latex.codecogs.com/gif.latex? Score=N_1^{'}*C_1+N_2^{'}*C_2^{'}+....+N_n^{'}*C_n" />
...
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;if <img src="https://latex.codecogs.com/gif.latex? Score \gt N_1^{'}*C_1+N_2^{'}*C_2+....+N_t^{'}*C_t" />
